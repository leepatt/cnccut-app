...
export default function LandingPage() {
  return (
    <div className="bg-gray-900 text-gray-100 font-sans relative isolate overflow-hidden">
      <GridBackground />
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col items-center justify-center text-center p-8 relative z-10">
      ...
      <section className="py-16 md:py-24 bg-gray-800 relative z-10">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <Settings className="h-8 w-8 text-[#B80F0A] mb-3" />
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <ScanEye className="h-8 w-8 text-[#B80F0A] mb-3" />
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <Bolt className="h-8 w-8 text-[#B80F0A] mb-3" />
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <Box className="h-8 w-8 text-[#B80F0A] mb-3" />
             ...
             <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <BarChart className="h-8 w-8 text-[#B80F0A] mb-3" />
             ...
             <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-[#B80F0A]/50 transition duration-300">
              <FileText className="h-8 w-8 text-[#B80F0A] mb-3" />
        ...
        <div className="container mx-auto px-6 max-w-5xl text-center">
           ...
           <h2 className="text-3xl md:text-4xl font-semibold mb-12 text-white">Why CNC Cut?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gray-900 p-6 rounded-lg border border-transparent hover:border-[#B80F0A]/50 transition duration-300">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-t from-gray-900 to-gray-800 relative z-10">
